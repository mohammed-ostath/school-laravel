...
<td>
    <div class="dropdown show">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            ...
            <a class="dropdown-item" href="{{route('ProcessingFee.show',$student->id)}}"><i style="color: orange" class="fas fa-money-bill-alt"></i>&nbsp; &nbsp; استبعاد رسوم</a>
            ...
            <a class="dropdown-item" href="{{route('Graduated.edit',$student->id)}}"><i style="color: red" class="fa fa-edit"></i>&nbsp;تخرج الطالب&nbsp;</a>
